...
2. Gather evidence from literature, clinical trials, Open Targets, ChEMBL, CIViC, ClinGen, cBioPortal, DepMap/COSMIC-compatible sources, and other bio data sources as relevant.
